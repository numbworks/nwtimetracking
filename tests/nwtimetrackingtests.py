...
class TimeTrackingManagerTestCase(unittest.TestCase):
    ...
    def test_getsessionsdataset_shouldreturnexpecteddataframe_wheninvoked(self):
        ...
        with patch.object(pd, 'read_excel', return_value = excel_data_df) as mocked_context:
            actual : DataFrame = TTDataFrameFactory().create_tt_df(setting_bag = setting_bag)
    ...
    def test_getttbyyear_shouldreturnexpecteddataframe_wheninvoked(self):
        ...
        # Act
        actual_df : DataFrame  = TTDataFrameFactory().create_tts_by_year_df(tt_df = sessions_df, years = years, yearly_targets = yearly_targets)
    ...
    def test_getttbyyearmonth_shouldreturnexpecteddataframe_wheninvoked(self):
        ...
        # Act
        actual_df : DataFrame  = TTDataFrameFactory().create_tts_by_year_month_tpl(tt_df = sessions_df, years = years, yearly_targets = yearly_targets)
    ...
    def test_getttbyyearmonthspnv_shouldreturnexpecteddataframe_wheninvoked(self):
        ...
        # Act
        actual_df : DataFrame  = TTDataFrameFactory().create_tts_by_year_month_spnv_tpl(tt_df = sessions_df, years = years, software_project_names = software_project_names)
    ...
    def test_getttbyyearspnv_shouldreturnexpecteddataframe_wheninvoked(self):
        ...
        # Act
        actual_df : DataFrame  = TTDataFrameFactory().create_tts_by_year_spnv_tpl(tt_df = sessions_df, years = years, software_project_names = software_project_names)
    ...
    def test_getttbyspnspv_shouldreturnexpecteddataframe_wheninvoked(self):
        ...
        # Act
        actual_df : DataFrame  = TTDataFrameFactory().create_tts_by_spn_spv_df(tt_df = sessions_df, years = years, software_project_names = software_project_names)
    ...
    def test_getttsbymonth_shouldreturnexpecteddataframe_wheninvoked(self):
        ...
        # Act
        actual_df : DataFrame  = TTDataFrameFactory().create_tts_by_month_tpl(tt_df = sessions_df, years = years)
    ...
    def test_createtimeranges_shouldreturnexpecteddataframe_wheninvoked(self):
        ...
        # Act
        actual_df : DataFrame  = TTDataFrameFactory().create_tts_by_tr_df(tt_df = sessions_df, unknown_id = unknown_id)
    ...
    def test_getttbyyearhashtag_shouldreturnexpecteddataframe_wheninvoked(self):
        ...
        # Act
        actual_df : DataFrame  = TTDataFrameFactory().create_tts_by_year_hashtag_df(tt_df = sessions_df, years = years)
    ...
    def test_getttbyhashtag_shouldreturnexpecteddataframe_wheninvoked(self):
        ...
        # Act
        actual_df : DataFrame  = TTDataFrameFactory().create_tts_by_hashtag_df(tt_df = sessions_df)
    ...
    def test_getttbyspn_shouldreturnexpecteddataframe_wheninvoked(self, remove_untagged : bool):
        ...
        # Act
        actual_df : DataFrame  = TTDataFrameFactory().create_tts_by_spn_df(tt_df = sessions_df, years = years, software_project_names = software_project_names, remove_untagged = remove_untagged)
